 ...
 * relations entre eux ainsi que d'attribuer à chaque pirate l'objet recu apres
...
public class Equipage {
	...
	/**
	 * La methode permet à l'utilisateur d'ajouter une relation de rancoeur entre
	 * deux pirates en ajoutant 1 au tableau à 2 dimension 
	 * 
	...
	public void addRelation(Pirate A, Pirate B) {
		...
		if (validation) {
			...
			System.out.println(
					"La relation  ne s'aiment pas entre " + A.getID() + " et " + B.getID() + " a bien été ajoutée");
		} else {
	...
	/**
	 * La methode permet de verifier si (à partir de l'ID d'un pirate passer en
	 ...
	 * @return l'objet pirate dans le cas ou nous l'avons trouver qu'il appartient à
	...
	/**
	 * La méthode permet d'affecter de façon naive à chaque pirate un objet parmi
	 * ceux qu'il y a à partager. Chaque pirate sera associé à un objet est sera
	...
	/**
	 * La methode permet à l'utilisateur d'echanger les objets entre deux pirates en
	 * utilisant la HashMap
	 * 
	 * @param A represente le pirate qui a l'un des objets à echanger
	...
	/**
	 * La méthode calcule le nombre de pirate jaloux dans l'equipage après
	...
	/**
	 * La méthode verifie si deux pirates ne s'aiment pas
	 * 
	...
	/**
	 * Méthode qui verifie si l'ID (nom) x d'un pirate se trouve dans un ArrayList
	 * xs
	 * 
	 * @param x  represente l'ID d'un pirate qui est sous forme d'un String
	 * @param xs represente un tableau dynamique qui contient à l'interieur les IDs
	 *           de certains pirates
